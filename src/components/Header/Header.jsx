    ...
    <div>
      ...
      >
        <div className="head d-flex align-items-center justify-content-between">
          <h4>Order (12)</h4>
          <span><Settings className="set"/></span>
        </div>
        ...
        <MenuItem onClick={handleClose}>
          ...
          Logout
              ...
              <Button className="rounded-circle" onClick={HandleNotificationClick}>
      ...
      >
        ...
        <MenuItem onClick={HandleNotificationClose }>
          ...
          Logout
              ...
              <Button className="myAccWrapper d-flex align-items-center " onClick={myAccHandleClick}>
